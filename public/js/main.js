...
Ext.onReady(function() {
	...
	var viewport = new Ext.Viewport({
		...
		items: [{
			region: 'north',
			height: 40,
			html: '<body><div style="position:relative;height:40px;line-height:40px;font-size:24px;color:#fff;background:#f8851f url(/ext-4.0.7-gpl/resources/themes/images/custom/icon.png) no-repeat 0 0;border-bottom:1px solid #c66a19;zoom:1;padding-left:48px;">Admin Console ' +
				'<span style="font-size: 15px;"><a href="/logout">退出登录</a> <a href="/changepass">修改密码</a></span></div>' +
				'</body>'
		},
